...
public class CombineLinkedList 
{
	public static void main(String[] args) 
	{
		...
		HeroNode heroNode6 = new HeroNode(6, "张顺", "浪里白条");
		HeroNode heroNode7 = new HeroNode(7, "武松", "行者");
		HeroNode heroNode8 = new HeroNode(8, "林冲", "豹子头");
		HeroNode heroNode9 = new HeroNode(9, "史进", "九纹龙");
		HeroNode heroNode10 = new HeroNode(10, "燕青", "浪子");

		//定义一个链表
		SingleLinkedList sll1 = new SingleLinkedList();
		sll1.addByOrder(heroNode1);
		sll1.addByOrder(heroNode4);
		sll1.addByOrder(heroNode5);
		sll1.addByOrder(heroNode3);
		sll1.addByOrder(heroNode7);

		//定义第二个链表
		SingleLinkedList sll2 = new SingleLinkedList();
		sll2.addByOrder(heroNode10);
		sll2.addByOrder(heroNode6);
		sll2.addByOrder(heroNode8);
		sll2.addByOrder(heroNode2);
		sll2.addByOrder(heroNode9);

		//展示链表
		System.out.println("sll1打印:");
		sll1.showLinkedList();
		System.out.println("sll2打印:");
		sll2.showLinkedList();

		System.out.println("合并后打印:");
		
		//逆序打印数据
		SingleLinkedList.combine(sll1.getHead(), sll2.getHead()).showLinkedList();
	}
}
...
class SingleLinkedList
{
	...
	{
		//定义一个辅助节点来遍历链表2，按序插入到链表一中
		HeroNode toolMan = head2.getNext();
		HeroNode toolManNext;
		SingleLinkedList sll = new SingleLinkedList(head1);
		while (toolMan != null)
		{
			toolManNext = toolMan.getNext();
			sll.addByOrder(toolMan);
			toolMan = toolManNext;
		}
		return sll;
	}
